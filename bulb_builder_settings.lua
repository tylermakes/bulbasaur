...
BulbBuilderSettings = class(function(c)
	...
	types[4] = { id=4, tileName="enemy1", color=BulbColor(0.8,0,0.6) }
	...
	types[9] = { id=9, tileName="lava", color=BulbColor(1, 0.6, 0) }
	types[10] = { id=10, tileName="dirt", color=BulbColor(0.8,0.6,0) }
	c.types = types
