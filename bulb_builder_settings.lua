...
BulbBuilderSettings = class(function(c)
	...
	types[6] = { id=6, tileName="river", walkable=5, enemyWalkable=true, color=BulbColor(0,0,1) }
	types[7] = { id=7, tileName="seeds", walkable=1, enemyWalkable=true, color=BulbColor(1,0,0), seed="strawberry"}
	types[8] = { id=8, tileName="wall", color=BulbColor(0.3, 0.3, 0.3) }
	types[9] = { id=9, tileName="lava", walkable=10, enemyWalkable=true, color=BulbColor(1, 0.6, 0) }
	types[10] = { id=10, tileName="dirt", walkable=1, enemyWalkable=true, color=BulbColor(0.8,0.6,0) }
	types[11] = { id=11, tileName="enemy3", isEnemy=true, color=BulbColor(0.3,0.1,0.1) }
	types[12] = { id=12, tileName="nav", walkable=100, enemyWalkable=true, customData={nav="bulb_game_scene"}, color=BulbColor(0.4,0.4,0.4) }
	types[13] = { id=13, tileName="grass", walkable=2, enemyWalkable=true, color=BulbColor(0.4, 0.6, 0.2) }
	types[14] = { id=14, tileName="enemy4", isEnemy=true, color=BulbColor(0,0,0) }
	types[15] = { id=15, tileName="bush", walkable=15, color=BulbColor(0.4,0.6,0.5) }
	c.types = types
