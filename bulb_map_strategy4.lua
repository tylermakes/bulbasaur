...
BulbMapStrategy4 = class(function(c)
end)

function BulbMapStrategy4:generateMap( baseMap, rows, columns, tileSize, previousLocation, currentLocation )
	local map = {}
	local forestTile = {}
