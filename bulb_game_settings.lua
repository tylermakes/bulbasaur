...
BulbGameSettings = class(function(c)
	...
	types["avocado"] = { id=3, tileName="avocado", harvestTime=100, cost=1003, color=BulbColor(0,0.6,0) }
	types["blueberries"] = { id=4, tileName="blueberries", harvestTime=100, cost=1004, color=BulbColor(0,0,1) }
	types["lemon"] = { id=5, tileName="lemon", harvestTime=200, cost=1005, color=BulbColor(1,1,0.6) }
	types["carrots"] = { id=6, tileName="carrots", harvestTime=130, cost=1007, color=BulbColor(1,0.8,0) }
	types["beets"] = { id=7, tileName="beets", harvestTime=150, cost=10010, color=BulbColor(0.8,0,.5) }
	types["peas"] = { id=8, tileName="peas", harvestTime=80, cost=1009, color=BulbColor(0,0.8,0) }
	types["pineapple"] = { id=9, tileName="pineapple", harvestTime=100, cost=1006, color=BulbColor(1,1,0) }
	types["asparagus"] = { id=10, tileName="asparagus", harvestTime=100, cost=1008, color=BulbColor(0.3,0.6,0.3) }
	c.types = types
